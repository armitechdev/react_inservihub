...
function AllFeaturedListings() {
    const allFeaturedListings = useSelector(store => store.listings.allFeaturedListings)
    const dispatch = useDispatch();

    useEffect(() => {
        dispatch(getAllFeaturedListingsAction())
    }, []);
    ...
    return (
        <Wrapper>
            <HelmetComponent
                title={'Featured Businesses | InServiHub'}
                description={"This is a Featured Businesses page"}
                // href={`${REACT_APP_URL}/featured-businesses/`}
                // social_title={'Featured Businesses | InServiHub'}
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 col-md-12">
                            <h1 className="big-header-capt capti">Featured Businesses around you</h1>
                            <h4 className="big-header-h4">Navigate the Business World: Find, Connect, Grow – Locally & Beyond</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div className="row">
                    {allFeaturedListings && allFeaturedListings.length ?
                        allFeaturedListings?.map(listing =>
...
export default AllFeaturedListings;